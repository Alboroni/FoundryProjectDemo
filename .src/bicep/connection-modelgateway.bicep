...
param projectResourceId string = '/subscriptions/1db73ea7-07ac-4071-a65a-1ebc330822bb/resourceGroups/TestProj/providers/Microsoft.CognitiveServices/accounts/connectionTest/projects/proj-connectiontest'
param targetUrl string = 'https://apim-alexyoai.azure-api.net/modelalexyo-resource/openai'
param gatewayName string = 'GatewayApim'
...
@secure()
param apiKey string = 'ec97a15bf63d4853ac784a15bb041830'
...
// Note: Consider configuring either static models OR dynamic discovery for best results
// Using both or neither may lead to unexpected behavior
...
// Deploy the ModelGateway connection
