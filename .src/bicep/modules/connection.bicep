...
param apimResourceId string = '/subscriptions/0cefe216-ec0c-46f8-821b-f141d13f5c2a/resourceGroups/apim-rg/providers/Microsoft.ApiManagement/service/apim-alexyoai     '

@description('Name of the API in APIM')
param apiName string = 'modelalexyo-resource'
...
param apimSubscriptionName string = 'alexyo-model-resource-alexyo-model-ai-mtxglhvhzy'
